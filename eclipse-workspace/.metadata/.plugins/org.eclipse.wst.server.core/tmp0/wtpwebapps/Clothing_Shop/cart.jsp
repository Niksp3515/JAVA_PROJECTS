...
<html lang="en">
  ...
  <div id="content"> <!-- Content -->
                                          ...
                                          <div class="col-md-3 prdct-grid">
                                              <div class="product-fade">
													<div class="product-fade-wrap">
                                                            <div class="item"><img src="product_images/<%= p.getProduct_image() %>" alt="" class="img-responsive" style="width: 300px;height: 300px"></div>
                                              ...
                                              <div class="product-name">
                                                  <form action="change_qty.jsp" method="post" name="change_qty">
          ...
          <form >
          <input type="text" value="<%=net_price%>" id="amount1">
          </form>
	...
	{
		xhttp.open("GET","http://localhost:8080/Clothing_Shop/OrderCreation?amount=<%= net_price%>",false);
		xhttp.send();
...
<script src="https://checkout.razorpay.com/v1/checkout.js"></script>
	...
	function OpenCheckOut()
	{
		...
		var options={
				...
				"description":"Test",
				"callback_url":"http://localhost:8080/Clothing_Shop/update_payment.jsp?uid=<%=u.getUid()%>",
				"prefill" : {
					"name" : "Nikhil Prajapati",
