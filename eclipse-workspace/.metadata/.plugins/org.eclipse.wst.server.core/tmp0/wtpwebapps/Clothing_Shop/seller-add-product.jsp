              ...
              <div class="page-title">
                  <div class="container">
                      <div class="page-title-inner">
                          <h3>Add Products</h3>
                          <div class="breadcumb"> <a href="">Home</a><span> / </span><span>Add Products</span></div>
                              ...
                              <form class="contact-form" action="ProductController" method="post" enctype="multipart/form-data">
                               <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="product_name" id="fname" placeholder="">
                                  </div>
                                   <div class="form-group">
                                      <label for="cf_name">Product Price*</label>
                                      <input type="text" class="form-control" name="product_price" id="lname" placeholder="">
                                  </div>
