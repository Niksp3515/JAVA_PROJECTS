                                              ...
                                              <div class="product-fade">
													<div class="product-fade-wrap">
														...
														<div class="product-fade-ct">
                                                            ...
                                                            %>
                                                             <a href="remove-from-cart.jsp?pid=<%=p.getPid() %>&uid=<%= u.getUid() %>" class="btn btn-to-cart"><span>Remove From  Cart</span></a> 
                                                            <%
                                                                }
                                                            %>
                                                                
                                                                <%
                                                                	boolean flag = WishListDao.CheckWhishList(u.getUid(), p.getPid());
                                                                if(flag == false){
                                                                %>
                                                            ...
                                                            %>
                                                             <a href="remove-from-wishlist.jsp?pid=<%=p.getPid() %>&uid=<%= u.getUid() %>" class="btn btn-to-cart"><span>Remove From  WishList</span></a> </div>
                                                            <%
                                                                }
                                                            %>
                                                            <%
