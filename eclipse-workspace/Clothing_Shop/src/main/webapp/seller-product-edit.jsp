              ...
              <div class="page-title">
                  <div class="container">
                      <div class="page-title-inner">
                          <h3>Edit Products</h3>
                          <div class="breadcumb"> <a href="">Home</a><span> / </span><span>Edit Products</span></div>
                              ...
                              <form class="contact-form" action="ProductController" method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="pid" value="<%= p.getPid()%>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="product_name" id="fname" value="<%= p.getProduct_name()%>">
                                  </div>
                                   <div class="form-group">
                                      <label for="cf_name">Product Price*</label>
                                      <input type="text" class="form-control" name="product_price" id="lname" value="<%= p.getProduct_price()%>">
                                  </div>

                                 <div class="form-group">
                                      <label for="cf_email">Product Image*</label>
                                      <input type="file" class="form-control" name="product_image" id="cf_email">
                                  </div> 
                                  <div class="form-group">
